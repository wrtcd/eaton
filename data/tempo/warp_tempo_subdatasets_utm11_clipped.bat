...
call :flt   "NETCDF:%NC%:/support_data/scattering_weights"              tempo_sup_scattering_weights_utm11_clipped.tif
call :flt   "NETCDF:%NC%:/support_data/gas_profile"                     tempo_sup_gas_profile_utm11_clipped.tif
